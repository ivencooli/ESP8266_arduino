...
const char* ssid = "malimalihome"; //type your WIFI information inside the quotes
const char* password = "922727lm";
const char* mqtt_server = "192.168.123.110";
const char* mqtt_username = "ming";
const char* mqtt_password = "9227";
